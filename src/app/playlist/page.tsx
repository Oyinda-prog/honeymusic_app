...
<div>
        ...
        
     {
        api.map(music=>(
          ...
          <div key={music.id} className='ms-10 text-[20px] w-[80%]  md:bg-[#949192] opacity-90 md:w-[80%] my-15 b shadow rounded-3xl p-4'>
            {
              !music.id?(
                <div>
        ...
        <p className='text-dark font-bold text-[18px] mt-5 mb-3'>{music.songTitle}</p>
